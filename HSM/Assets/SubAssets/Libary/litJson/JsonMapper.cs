    ...
    public class JsonMapper
    {
        ...
        private static object ReadValue (Type inst_type, JsonReader reader)
        {
            ...
            if (reader.Token == JsonToken.Double ||
                ...
                if (inst_type.IsAssignableFrom(typeof(System.Single)) && json_type.IsAssignableFrom(typeof(System.Double)))
                {
                    float ddd = (System.Single)((System.Double)reader.Value);
                    return (System.Single)((System.Double)reader.Value);
                }

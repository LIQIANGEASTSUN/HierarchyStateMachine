...
public class SkillBrush : HSMState/*, ISkill*/
{
    private static CustomIdentification _customIdentification = new CustomIdentification("技能/刷子甩", IDENTIFICATION.SKILL_SWING_BRUSH, typeof(SkillBrush), NODE_TYPE.STATE);

    //private Skill _skill;

    public SkillBrush():base()
    {
        Debug.LogError("SkillBrush");
    }
